...
**************************************************************************/
	public ArrayList <CartaPuebloDuerme> RepartirCartas(){
		...
		//Creo un array de tamaño 6 para las cartas que voy a utilizar (como si fuera la baraja)
		...
		//Creo los 6 objetos de la clase CartaPuebloDuerme que voy a utilizar (Un lobo y 5 pueblerinos)
		...
		//Cargo ordenadamente el array de cartas con 6 cartas (un lobo y 5 pueblerinos)
