...
/*6. Añade una nueva columna a LQ_Moleculas llamada codigo. Será de tipo entero, identidad y defínela como clave primaria.*/

ALTER TABLE LQ_Moleculas ADD
	codigo int NOT NULL IDENTITY(1,1)
		CONSTRAINT PK_LQ_Moleculas PRIMARY KEY

/*7. Crea una nueva tabla que relacione LQ_Elementos con LQ_Moleculas, llámala LQ_MoleculasElementos.
Añade una columna numero que indique el subíndice del elemento en la molécula (entero corto sin nulos, valor mínimo 1).
